      ...
      <div className="w-full max-w-md bg-[#18181c] border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden text-zinc-200">
        <div className="px-5 py-4 border-b border-zinc-800/80 flex items-center justify-between">
          <div className="flex items-center gap-2 text-blue-400">
            ...
            <h3 className="text-base font-bold text-white">Create Task List</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-zinc-300 mb-1.5">List Name</label>
            <input
              type="text"
              required
              autoFocus
              ...
              placeholder="e.g. Sprint Backlog, Client Milestones..."
              className="w-full px-3.5 py-2.5 bg-zinc-900 border border-zinc-700/80 rounded-xl text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-blue-500 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 bg-zinc-900 border border-zinc-700/80 rounded-xl text-xs text-zinc-200 focus:outline-none focus:border-blue-500"
            >
          ...
          <div className="pt-2 flex justify-end gap-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-5 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white shadow-lg disabled:opacity-50 transition-colors"
            >
